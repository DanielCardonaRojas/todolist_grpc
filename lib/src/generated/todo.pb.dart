...
class TodoItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TodoItem', createEmptyInstance: create)
...
class TodoItemEdit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TodoItemEdit', createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'title')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..hasRequiredFields = false
  ;

  TodoItemEdit._() : super();
  factory TodoItemEdit({
    $core.String title,
    $core.String description,
  }) {
    final _result = create();
  ...
  factory TodoItemEdit.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TodoItemEdit.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TodoItemEdit clone() => TodoItemEdit()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TodoItemEdit copyWith(void Function(TodoItemEdit) updates) => super.copyWith((message) => updates(message as TodoItemEdit)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TodoItemEdit create() => TodoItemEdit._();
  TodoItemEdit createEmptyInstance() => create();
  static $pb.PbList<TodoItemEdit> createRepeated() => $pb.PbList<TodoItemEdit>();
  @$core.pragma('dart2js:noInline')
  static TodoItemEdit getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TodoItemEdit>(create);
  static TodoItemEdit _defaultInstance;
...
class TodoItems extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TodoItems', createEmptyInstance: create)
